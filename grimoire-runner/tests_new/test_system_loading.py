...
from grimoire_runner.models.system import System, Currency, CurrencyDenomination, Credits
...
class TestBasicSystemLoading:
    ...
    def test_load_minimal_system(self, test_systems_dir):
        ...
        assert system.description == "Simplest possible valid GRIMOIRE system for testing basic system loading"
...
class TestSystemBuilderUtility:
    ...
    def test_basic_system_builder(self, system_builder):
        ...
        system_dir = (system_builder("builder_test")
    ...
    def test_system_builder_with_currency(self, system_builder):
        ...
        system_dir = (system_builder("currency_builder_test")
