...
from ..models.system import System, Currency, CurrencyDenomination, Credits
from ..models.flow import FlowDefinition, StepDefinition, StepType, InputDefinition, OutputDefinition, ChoiceDefinition, TableRollDefinition, DiceSequenceDefinition, LLMSettingsDefinition
from ..models.model import ModelDefinition, AttributeDefinition, ValidationRule
...
class SystemLoader:
    ...
    def _load_system_definition(self, system_file: Path) -> System:
        ...
        if 'currency' in data:
            ...
            currency = Currency(
                base_unit=currency_data['base_unit'],
        ...
        if 'validations' in data:
            for val_data in data['validations']:
                if isinstance(val_data, str):
                    ...
                    validations.append(ValidationRule(expression=val_data, message=f"Validation failed: {val_data}"))
    ...
    def reload_system(self, system_id: str) -> Optional[System]:
