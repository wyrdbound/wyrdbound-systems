...
class ConditionalExecutor(BaseStepExecutor):
    ...
    def execute(self, step: "StepDefinition", context: "ExecutionContext", system: "System") -> "StepResult":
        ...
        template_context = {
            ...
            "system": context.system_metadata if hasattr(context, 'system_metadata') else {},
        }
    ...
    def _execute_action_list(self, actions: list[dict], context: "ExecutionContext", system: "System"):
    ...
    def _execute_nested_conditional(self, conditional_data: dict, context: "ExecutionContext", system: "System"):
    ...
    def validate_step(self, step: "StepDefinition") -> list[str]:
        ...
        if not step.then_actions and not step.else_actions:
            errors.append("Conditional step must have at least 'then' or 'else' actions")
