...
class CompendiumDefinition:
    ...
    def search_entries(self, search_term: str, fields: Optional[List[str]] = None) -> Dict[str, Dict[str, Any]]:
    ...
    def _entry_matches_search(self, entry_data: Dict[str, Any], search_term: str, fields: Optional[List[str]] = None) -> bool:
