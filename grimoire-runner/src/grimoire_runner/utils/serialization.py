...
class SerializationHelpers:
    ...
    @staticmethod
    def save_to_file(data: Any, file_path: Union[str, Path], format: Optional[str] = None) -> None:
    ...
    def flatten_dict(data: Dict[str, Any], separator: str = '.', prefix: str = '') -> Dict[str, Any]:
        ...
        for key, value in data.items():
            ...
            if isinstance(value, dict):
                result.update(SerializationHelpers.flatten_dict(value, separator, new_key))
            else:
