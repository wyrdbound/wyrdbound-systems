...
class DiceIntegration:
    ...
    def roll_expression(self, expression: str, modifiers: Optional[Dict] = None) -> DiceResult:
    ...
    def _roll_with_wyrdbound(self, expression: str, modifiers: Optional[Dict] = None) -> DiceResult:
    ...
    def _roll_fallback(self, expression: str, modifiers: Optional[Dict] = None) -> DiceResult:
    ...
    def _get_roll_breakdown(self, result) -> Optional[Dict[str, Any]]:
    ...
    def _get_individual_rolls(self, result) -> Optional[list]:
