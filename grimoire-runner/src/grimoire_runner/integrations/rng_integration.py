...
try:
    ...
    RNG_AVAILABLE = False
    logger.warning("wyrdbound-rng package not available, using fallback name generation")
...
class RNGIntegration:
    ...
    def load_name_generator(self, file_path: str) -> Optional[Any]:
    ...
    def _generate_fallback_name(self, generator_id: str, **kwargs) -> str:
        ...
        first_names = [
            "Aiden", "Bran", "Cora", "Dara", "Ewan", "Fynn", "Gwen", "Hale",
            "Ivy", "Jace", "Kira", "Liam", "Maya", "Nora", "Owen", "Piper",
            "Quinn", "Raven", "Sage", "Tara", "Ursa", "Vale", "Wren", "Xara",
            "Yara", "Zara"
        ]
        
        last_names = [
            "Ashworth", "Blackwood", "Crowe", "Darkmore", "Ember", "Frost",
            "Grimm", "Hawke", "Ironside", "Kane", "Lightbringer", "Morrow",
            "Nightfall", "Oakheart", "Pierce", "Quicksilver", "Raven", "Stone",
            "Thornfield", "Underwood", "Vale", "Whitmore", "Youngblood", "Zephyr"
        ]
