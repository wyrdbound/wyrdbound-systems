...
class DebugModalApp(App):
    ...
    async def show_test_modal(self):
        ...
        print(f"[DEBUG] About to push_screen")
...
class TestModalDebug:
            ...
            if len(app.screen_stack) > 1:
                ...
                if isinstance(modal, SimpleChoiceModal):
                    ...
                    try:
                        ...
                        print(f"RadioSet found, pressed_button: {radio_set.pressed_button}")
                        ...
                        if radio_buttons:
                            ...
                            print(f"Screen stack length after confirm: {len(app.screen_stack)}")
    ...
    async def test_simple_radio_set(self):
        ...
        async with app.run_test() as pilot:
            ...
            radio_set = app.query_one("#test-radio", RadioSet)
            print(f"After click pressed_button: {radio_set.pressed_button}")
            print(f"Pressed button ID: {radio_set.pressed_button.id if radio_set.pressed_button else None}")
