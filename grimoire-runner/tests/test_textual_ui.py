...
class TestUIInteractions:
    ...
    async def test_keyboard_navigation(self):
        ...
        class TestApp(App):
            ...
            async def test_modal(self):
                choices = [MockChoice("first", "First"), MockChoice("second", "Second")]
...
class TestModalStates:
    ...
    async def test_modal_long_prompt(self):
        ...
        long_prompt = (
            "This is a very long prompt that should test how the modal handles " * 10
        )
    ...
    async def test_modal_long_choice_labels(self):
        ...
        long_label = (
            "This is an extremely long choice label that should test wrapping " * 5
        )
