...
from grimoire_runner.models.flow import FlowDefinition, FlowResult, StepResult
...
class TestGrimoireEngine:
    ...
    def test_engine_initialization(self):
        ...
        expected_executors = [
            'dice_roll', 'dice_sequence', 'player_choice', 
    ...
    def create_minimal_system(self, temp_dir: str, system_id: str = "minimal_system") -> Path:
    ...
    def test_execution_iterator(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            step_count = 0
            for step_result in self.engine.execute_flow_steps("multi_step_flow", context, system):
                step_count += 1
    ...
    def test_flow_execution_with_initial_context_data(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            context = self.engine.create_execution_context(
                variables={"pre_existing": "value"},
                inputs={"user_input": "test_input"}
            )
