...
class TestRNGIntegrationWithPackage:
    ...
    def test_initialization_with_package_error(self, mock_wyrdbound_rng):
        ...
        with patch.object(RNGIntegration, '__init__', side_effect=Exception("Init error")):
...
class TestRNGIntegrationLogging:
    ...
    def test_logging_on_generator_load_error(self, mock_wyrdbound_rng, mock_logger):
        ...
        mock_logger.error.assert_called_with(f"Failed to load name generator from {test_path}: {error_msg}")
    ...
    def test_logging_on_generate_error(self, mock_logger):
        ...
        mock_logger.error.assert_called_with(f"Error generating name with error_gen: {error_msg}")
    ...
    def test_logging_on_generator_not_found(self, mock_logger):
        ...
        mock_logger.warning.assert_called_with("Name generator 'nonexistent_generator' not loaded")
