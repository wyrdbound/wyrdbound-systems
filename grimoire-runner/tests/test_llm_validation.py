...
class TestLLMValidation:
    ...
    @patch.object(LLMIntegration, "generate_content", side_effect=create_mock_json_response)
    def test_json_validation_success(self, mock_generate):
        ...
        result_json, success, attempts, raw_response, errors = executor._attempt_llm_call_with_validation(
    ...
    @patch.object(LLMIntegration, "generate_content", side_effect=create_mock_invalid_json_response)
