...
#### Phase 1: Create UI Service Interface

1. **Define Service Interface**: Create clean contract between UI and engine
2. **Implement Engine Service**: Wrapper around existing engine with UI-friendly interface
3. **Create Event System**: Implement event publishing for UI updates
4. **Session Management**: Add execution session tracking

#### Phase 2: Refactor Rich TUI
...
4. **Remove Dead Code**: Eliminate unused classes and functions

#### Phase 5: Add Missing Abstractions

1. **Display State Service**: Manage UI state separately from execution state
2. **Configuration Service**: Centralized configuration management
3. **Logging Service**: Structured logging for debugging UI/engine interactions
...
### Week 2: Rich TUI Refactor

- Remove engine dependencies from Rich TUI
- Implement event-driven updates
- Test flow execution functionality

### Week 3: Other UIs

- Refactor browser UIs
- Update interactive REPL
